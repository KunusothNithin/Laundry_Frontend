    ...
    <footer className={`${bgColor} ${textColor} py-8 w-full transition-colors duration-300 border-t`}>
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className={`space-y-2 text-sm ${descriptionText}`}>
            <li>Email: <a href="mailto:support@laundryapp.com" className={`${linkHoverColor}`}>support@laundryapp.com</a></li>
            <li>Phone: <a href="tel:+91 9876543210" className={`${linkHoverColor}`}>+91 9876543210</a></li>
